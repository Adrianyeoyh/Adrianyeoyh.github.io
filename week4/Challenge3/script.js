...
function show(button_element) {
    ...
    */
    ...
    let person = button_element.id;
    document.getElementById("ta-fun-fact").innerText = facts[person];
    // console.log(`photos/${person}`)
    document.getElementById("ta-photo").src = `photos/${person}.jpg`;
